...
<template>
    <header
        class="pt-6 sm:pt-8 px-6 sm:px-8 flex flex-col sm:flex-row w-full max-w-7xl items-center sm:justify-between mb-4 sm:mb-8"
    >
        <Link
            :href="route('home')"
        ...
        >
            ...
            <div class="hidden md:block ml-4 font-bold text-lg">
                Francisco Madeira
            </div>
        </Link>
        <MainNav />
