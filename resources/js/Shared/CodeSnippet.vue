    ...
    <div class="code-snippet w-full">
        <div class="px-6 pt-4 pb-2 bg-black rounded-lg bg-opacity-60 w-full">
            <div class="flex justify-center items-center relative h-6">
                <div
                    v-if="name"
                    class="hidden sm:block text-gray-400 text-xs sm:text-sm"
                >
                    {{ name }}
                </div>
                ...
                <div
                    class="absolute right-0 text-xs text-gray-400 font-bold uppercase"
                >
                    {{ lang }}
                </div>
            </div>
            <div
                class="font-mono py-4 text-xs leading-6 sm:text-sm sm:leading-8 overflow-auto whitespace-pre scrollbar:w-2 scrollbar:h-2 scrollbar-track:bg-transparent scrollbar-thumb:rounded scrollbar-thumb:bg-gray-900"
            >
                <span
